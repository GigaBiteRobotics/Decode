	...
	protected void handleState(boolean stateChanged) {
		switch (currentState) {
			...
			case LAUNCH_BALLS:
				...
				if (launchTimer.milliseconds() > RedCloseAutoConstants.shotDelayMs && currentLaunchSlot < 3) {
				...
				if ((currentLaunchSlot >= 3 && launchTimer.milliseconds() > RedCloseAutoConstants.postLaunchDelayMs)
