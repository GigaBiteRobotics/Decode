...
public class MainDriveOpmode extends OpMode {
    ...
    public void init() {;
        ...
        launcher = hardwareMap.get(DcMotor.class, "launcher0");
    ...
    public void loop() {
        ...
        // Retrieve and display the robot's pose if available (apriltag)
        ...
        double launcherRPM = robotCoreCustom.getRPM(launcher, 28);
